...
function M.setup_highlights()
  -- Base colors - using a color scheme that works with most themes
  local colors = {
    { name = "BlamerCommit1", fg = "#7aa2f7" },
    { name = "BlamerCommit2", fg = "#bb9af7" },
    { name = "BlamerCommit3", fg = "#9ece6a" },
    { name = "BlamerCommit4", fg = "#f7768e" },
    { name = "BlamerCommit5", fg = "#e0af68" },
    { name = "BlamerCommit6", fg = "#7dcfff" },
    { name = "BlamerCommit7", fg = "#ff9e64" },
    { name = "BlamerCommit8", fg = "#c0caf5" },
  }
  ...
  vim.api.nvim_set_hl(0, "BlamerDate", { fg = "#565f89", italic = true })
  vim.api.nvim_set_hl(0, "BlamerMessage", { fg = "#9aa5ce" })
  vim.api.nvim_set_hl(0, "BlamerMessageBold", { fg = "#9aa5ce", bold = true })
end
